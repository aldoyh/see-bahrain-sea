...
<p><?php esc_html_e('No results.', 'bondigi');?></p>
<!-- /wp:paragraph -->
<!-- /wp:query-no-results -->
...
<h4 class="wp-block-heading"><?php esc_html_e('Search', 'bondigi');?></h4>
<!-- /wp:heading -->

<!-- wp:search {"label":"<?php esc_attr_e('Search', 'bondigi');?>","showLabel":false,"placeholder":"<?php esc_attr_e('Searching...', 'bondigi');?>","width":291,"widthUnit":"px","buttonText":"<?php esc_attr_e('Search', 'bondigi');?>","style":{"border":{"radius":"20px"}},"backgroundColor":"custom-heading"} /-->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Latest Posts', 'bondigi');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Categories', 'bondigi');?></h4>
<!-- /wp:heading -->
...
<!-- wp:heading {"level":4} -->
<h4 class="wp-block-heading"><?php esc_html_e('Tags', 'bondigi');?></h4>
<!-- /wp:heading -->
